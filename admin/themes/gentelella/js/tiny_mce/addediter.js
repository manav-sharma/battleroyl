tinymce.init({
        mode: "exact",
		selector : '#page-pagecontent,#updatepage-pagecontent,#emailmessage,#addseasons-season_venue,#updateseason-season_venue',
        ...
        plugins: [
                ...
                "table contextmenu directionality emoticons template textcolor paste textcolor image filemanager"
        ],
