    ...
    <div class="container">
      <div class="row">
		...
		<?php if (Yii::$app->session->getFlash('item')): ?>
		  ...
		  <?php endif; ?>
          <div class="message">
            <h4 class="messageTabSel"><?php  echo Html::a(Yii::t('yii','Inbox').'',['messages/index'],['title'=>'Inbox']);?></h4>
<!--
            <h4 class="messageTabUnSel"><?php  //echo Html::a(Yii::t('yii','Sent Messages').'',['messages/sent-messages'],['title'=>'Sent messages']);?></h4>
-->
            <div class="tableOuter">
               <?php
					$form = ActiveForm::begin(
						[ 
							'id' => 'message-form',
							'action' => ['messages/removemessages'],
							'options' => [
              ...
              <table class="table ">
                ...
                <tbody method="post">
				  ...
				  ?>
                  <tr <?php if($msg['is_read'] == 0 && $msg['user_from'] != $userId) { ?> class="unread" <?php } ?>>
                    <td>
						<div class="Checkbox">
<!--
							<input type="checkbox" name="optcheckbox[]" class="selectRow" value="<?= $msg['message_id'] ?>">
-->
							<input type="checkbox" name="optcheckbox[]" class="selectRow" value="<?= $thread_ID ?>">
							<?php 
								if($msg['send_status'] == '1') {
									$custName = "Admin";
								} else if($msg['user_from'] == $userId){
    $custName = 'Me: '.(isset($msg['tofn']) ? $msg['tofn'] : '')." ".(isset($msg['toln']) ? $msg['toln'] : '');                                                            }else{$custName = (isset($msg['fromfn']) ? $msg['fromfn'] : '')." ".(isset($msg['fromln']) ? $msg['fromln'] : '');
								}
							?>
							<?= Html::a(substr($custName,0,30), ['messages/viewmessage', 'id' => $msg['message_id']]) ?>
                        </div>
                    </td>
