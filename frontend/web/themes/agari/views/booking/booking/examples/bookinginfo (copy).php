...
$pdf->Cell(0, 5, 'Booking Information', 0, 1, 'C');
$pdf->Ln(10);
$pdf->SetFont('helvetica', '', 12);

// Reference number
$pdf->Cell(40, 5, 'Reference Number:');
//$pdf->TextField('referencenumber', 50, 5,array('multiline'=>true, 'lineWidth'=>0, 'borderStyle'=>'none'), array('v'=> $booking->reference_number, 'dv'=>'--'));
$pdf->Write(0, $booking->reference_number);
$pdf->Ln(6);

// Name
$pdf->Cell(40, 5, 'Name:');
//$pdf->TextField('name', 50, 5,array('multiline'=>true, 'lineWidth'=>0, 'borderStyle'=>'none'), array('v'=> $name, 'dv'=>'--'));
$pdf->Write(0, $name);
$pdf->Ln(6);

// Location
$pdf->Cell(40, 5, 'Location:');
//$pdf->TextField('address', 60, 18, array('multiline'=>true, 'lineWidth'=>0, 'borderStyle'=>'none'), array('v'=> $booking->booking_destination, 'dv'=>'--'));
$pdf->Write(0, $booking->booking_destination);
$pdf->Ln(19);

// Name
$pdf->Cell(40, 5, 'Amount:');
//$pdf->TextField('amount', 50, 5,array('multiline'=>true, 'lineWidth'=>0, 'borderStyle'=>'none'), array('v'=> $txtAmount, 'dv'=>'--'));
$pdf->Write(0, $txtAmount);
$pdf->Ln(6);

// Name
$pdf->Cell(40, 5, 'Travellers:');
//$pdf->TextField('travellers', 50, 5,array('multiline'=>true, 'lineWidth'=>0, 'borderStyle'=>'none'), array('v'=>$booking->no_of_travellers, 'dv'=>'--'));
$pdf->Write(0, $booking->no_of_travellers);
$pdf->Ln(6);
/*
//Gender
...
//$pdf->TextField('bookingdate', 30, 5, array(), array('v'=> $bookingDate, 'dv' => date('Y-m-d')));
$pdf->Write(0, $bookingDate);
$pdf->Ln(10);
$pdf->SetX(50);
/*
