...
<div class="x_content">
    ...
    ?>
    <?php
    $maincity = ArrayHelper::map(\common\models\Maincity::find()->all(), 'main_city_id', 'main_city_name');
    //echo '<pre>'; print_r($maincity);
    
    echo $form->field($model, 'main_city_id')->dropDownList($maincity, ['prompt'=>'Select Parent City'])->label('Select Parent City <span class="required">*</span>')
    ?>
    
    <?= $form->field($model, 'sub_city_name')->textInput(['maxlength' => true]) ?>
