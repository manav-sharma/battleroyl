		...
		<div class="fullwidth">
                  <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="form-group ">
                      ...
                      <div class="val">
                        <div class="controls">
                          <input type="password" class="form-control textfeild validate[required]" value="Jake">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="fullwidth">
                  <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="form-group ">
                      ...
                      <div class="val">
                        <div class="controls">
                            <select class="textfeild validate[required]" id="city" >
                    ...
                    <div class="form-group ">
                       ...
                       <div class="selectBg">
                        <div class="val">
                          <div class="controls">
                            <select class="textfeild validate[required]" id="state" >
                ...
                <span class="input-group-addon" ng-click="open1()"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                    ...
                    <?php
                     echo $form->field($model, 'usrPhone', ['inputOptions' => [
                         'data-validate-length-range' => "6,10",
                     ]])->textInput()->label('Phone Number <span class="required">*</span>');
               ?>
