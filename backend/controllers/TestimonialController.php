...
use backend\models\testimonial\AddTestimonial;
use backend\models\testimonial\TestimonialSearch;
use backend\models\testimonial\UpdateTestimonial;
...
class TestimonialController extends Controller
{
    ...
    */
    ...
    public function actionIndex() {
		$searchModel  = Yii::createObject(TestimonialSearch::className());
    ...
    */
    ...
    public function actionCreate() {
        ...
        $data = array();
        $model = new AddTestimonial();
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
			$postval 			= Yii::$app->request->post('AddTestimonial');
            $model->image 		= '';
            $model->status   	= '1';
            ...
            if ($model->addtestimonial()) {
                Yii::$app->session->setFlash('item', 'Testimonial has been created successfully!');
    ...
    */
    public function actionUpdate($id) {
        ...
        $updateTestimonial	= new UpdateTestimonial();
        $model 		 		= $updateTestimonial->findIdentity($id);
        $userpost 	 		= Yii::$app->request->post('UpdateTestimonial');
        ...
        if(isset($userpost) && !empty($userpost)) {
            #######################= FILE UPLOAD =######################
				...
				if($model->load(Yii::$app->request->post()) && $model->updatetestimonial($id)) {
    ...
    public function actionStatus($id) {
         ...
         if(isset($postArr) && !empty($postArr)) {
            if (Yii::$app->request->isAjax){
                ...
                if($model->save()) {
                    Yii::$app->session->setFlash('item' ,'Testimonial status has been changed successfully.');
                } else {
