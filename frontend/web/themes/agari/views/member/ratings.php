      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-md-9">
          <ul class="personsearch personrate">
				...
				<li>
					<div class="media">
						<div class="media-left pull-left">
							<div class="feedbackwrapper"><img src="<?= $profile_pic ?>" alt="person" onerror="this.onerror=null;this.src='<?php echo NOIMAGE107x114;?>'"> </div>
						</div>
           ...
           ?> 
				<li>
					<div class="media"><?php echo Yii::t('yii','No ratings and feedback yet!'); ?>
					</div>
				</li>
			<?php } ?>	           
          </ul>
