...
use backend\models\memberships\AddPackage;
use backend\models\memberships\PackageSearch;
use backend\models\memberships\UpdatePackage;
...
class MembershipsController extends Controller
{
    ...
    public function actionIndex() {
		$searchModel  = Yii::createObject(PackageSearch::className());
    ...
    */
    public function actionUpdate($id) {
        ...
        $updateNews	 		= new UpdatePackage();
        $model 		 		= $updateNews->findIdentity($id);
        $userpost 	 		= Yii::$app->request->post('UpdatePackage');
        ...
        if(isset($userpost) && !empty($userpost)) {
				...
				//~ if (Yii::$app->request->isPost) {
					...
					//~ }
				//~ }
				if($model->load(Yii::$app->request->post()) && $model->updatepackage($id)) {
					Yii::$app->session->setFlash('item', 'Membership plan has been updated successfully!');
					return $this->redirect(['index']);				
				} else {
					Yii::$app->session->setFlash('item', 'Please enter valid values for all the fields!');
				}
    ...
    */
    public function actionDelete($id) {
		$this->findModel($id)->delete();
		 Yii::$app->session->setFlash('item', 'Membership plan has been deleted successully!');
		return $this->redirect(['index']);
	}
