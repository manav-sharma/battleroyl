            ...
            <div class="profiledetail">
                  <div class="media">
                     ...
                     <div class="media-body">
                        ...
                        <h6><i aria-hidden="true" class="fa fa-map-marker"></i>Houston</h6>
                        <div class="rating3">
                           <ul>
                        ...
                        <a class="editprofile" href="<?php echo Yii::$app->homeUrl; ?>users/settings"><i class="fa fa-cog" aria-hidden="true"></i>Edit profile</a> </div>
                     </div>
               </div>
            <div class="detailwhite">
                     <h6>Personal information</h6>
                        <div class="table-responsive">
                           ...
                           <?php echo $attributes['usrFirstname']; ?></td>
                           <td><span>Last name</span><br/>
                           <?php echo $attributes['usrLastname'];?></td>
                           <td><span>email</span><br/>
                           <?php echo $attributes['email'];?></td>
                           </tr>
                           <tr>
                           <td><span>Birth date</span><br/>
                           13-08-1988</td>
                           <td><span>Gender </span><br/>
                           <?php echo $attributes['gender'];?></td>
                           <td><span>Country</span><br/>
                           <?php echo $attributes['usrCountry'];?></td>
                           </tr>
                           <tr>
                           <td><span>State</span><br/>
                           Houston</td>
