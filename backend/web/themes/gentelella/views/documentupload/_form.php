...
<div class="x_content">
    ...
    if(Yii::$app->controller->action->id == 'update')
        $modelName = 'UpdateDocument';
    else
        $modelName = 'AddDocumentForm';    
    ...
    <?php echo $form->field($modelDocumentUpload, 'filename')->fileInput(['accept' => '.doc, .docx, .txt, .ppt, .csv'])->label('File upload'); ?>
